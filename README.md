...
# Playing the Game of Plasma Using a Recursive Variation of the MuZero Reinforcement Learning Algorithm

## Introduction
This is the repo for the Playing the Game of Plasma Using a Recursive Variation of the MuZero Reinforcement Learning Algorithm project.
This project extending the [muzero-general repo](https://github.com/werner-duvaud/muzero-general), 
implementing the Plasma Naive Approach model & the Plasma Recursive Approach model. 
Additionally, we added a new main menu functionality in order to support large amount of tests.

## Extensions

### Plasma Naive Approach
Plasma naive approach implementation can be found under the games/plasme_naive.py.
<br>
To execute the Plasma Naive Approach Train or Test, kindly follow the guidelines of the main repo execution, 
while selecting 7 in the game selection menu.
#### Relevant Flags:
* training_steps - the amount of training steps, we used 10k and 100k
* MAX_TARGET_NUMBER - The max Target Number permitted (for both train and test), we used 10, 100 and 1000

### Plasma Recursive Approach
Plasma recursive approach implementation can be found under the games/plasme_recursive.py.
<br>
To execute the Plasma Recursive Approach Train or Test, kindly follow the guidelines of the main repo execution, 
while selecting 8 in the game selection menu.
#### Relevant Flags:
* training_steps - the amount of training steps, we used 10k and 100k
* MAX_TARGET_NUMBER - The max Target Number permitted (for both train and test), we used 10, 100 and 1000
* TOTAL_OPTIONS - The amount of options of the plasma board - default to 6
* VALIDATOR - Should we use the Validator - This should be set to false on train and should be set to True while testing our model

### Additional Changes
#### Run test multiple times: 
A new main menu option that runs a test scenario several times, and calculates the final win rate results
The implementation is available under muzero.py

***
⚠️From here this is the readme file of the main muzero-general repo⚠️
